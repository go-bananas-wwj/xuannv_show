...
const METRICS = [
  ...
  { label: '训练 Patches', value: '424', unit: '个', desc: '哈尔滨新区全覆盖' },
...
export default function AboutSection() {
  ...
  const goNext = () => setActiveTab((p) => (p + 1) % TABS.length)
  const goPrev = () => setActiveTab((p) => (p - 1 + TABS.length) % TABS.length)

  return (
    <section id="section-about" className="relative py-24 px-4">
              ...
              >
                <GlassPanel className="p-8">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 max-w-xl mx-auto">
                      在哈尔滨新区 424 个 patches 上的训练与验证表现
                    </p>
                  </div>
              ...
              >
                <GlassPanel className="p-8">
                  <div className="text-center mb-6">
                    ...
                    <p className="text-slate-500 max-w-xl mx-auto">
                      哈尔滨新区 424 个 patches 的空间分布与覆盖范围
                    </p>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="rounded-xl bg-slate-50 border border-slate-200 p-6">
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span className="text-slate-500">Patch 数量</span>
                        ...
                        <div className="flex justify-between">
                          <span className="text-slate-500">单 Patch 尺寸</span>
