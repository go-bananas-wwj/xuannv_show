...
export default function HeroSection({ onExplore }: HeroSectionProps) {
  return (
    ...
    >
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sky-600 text-sm mb-8 border-glow">
        ...
        <button
          onClick={onExplore}
          className="group inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-sky-50 border border-sky-200 text-sky-600 hover:bg-sky-100 hover:border-sky-300 transition-all duration-300"
        >
